...
public static class StdResponseFactory
{
    ...
    public static StdResponse<TValue> OkMsg<TValue>(string message) where TValue : class =>
    ...
    public static StdResponse<TValue> ValidationError<TValue>(object? data = default, string? message = null)
        where TValue : class =>
